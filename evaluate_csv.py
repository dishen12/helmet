...
def main(args=None):
    ...
    save_path = '/home/sy/keras-retinanet/result_imgs/'
    ...
    """
    all_detections     = _get_detections(generator, model, score_threshold=args.score_threshold, max_detections=args.max_detections, save_path=save_path)
    # print evaluation
    """
